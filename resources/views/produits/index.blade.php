@extends('dashboard')
@section('contenu')
<section class="bg-gray-50 white:bg-gray-900 py-3 sm:py-5">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" colspan="3" class="px-4 py-3">Action</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('produits.destroy', $product->id) }}" method="post">
                                        ...
                                        <a href="{{ route('produits.show', $product->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>

                                        <a href="{{ route('produits.edit', $product->id) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
